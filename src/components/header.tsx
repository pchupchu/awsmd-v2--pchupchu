...
const Header = () => {
  return (
    <header className='absolute left-0 right-0 top-0 flex w-full items-center justify-between px-4 pt-6'>
      <Logo imageSrc='/icons/logo-light.svg' textStyles='text-white' />
      <button
        className='fixed right-4 top-3 flex h-12 w-12 items-center justify-center rounded-full bg-white/40'
        type='button'>
